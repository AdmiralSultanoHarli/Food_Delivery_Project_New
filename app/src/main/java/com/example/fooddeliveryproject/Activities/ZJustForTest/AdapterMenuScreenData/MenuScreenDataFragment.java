...
public class MenuScreenDataFragment extends Fragment {
    ...
    String[] foodName = {"Veg Thali", "Goan Special", "Butter Chicken", "Murg Musallam", "Basmati Rice Chicken Biryani", "Jeera Alo", "Mix Veggies", "Panang Curry", "Chapati", "Samosa"};
    ...
    int[] img = {R.drawable.maharashtra_thali, R.drawable.butter_chicken, R.drawable.murg_musallam, R.drawable.basmati_rice_chicken_biryani,  R.drawable.mix_veggies, R.drawable.panang_curry, R.drawable.chapati, R.drawable.snacks};
