...
public class PreferencesUtility {
    ...
    public static final String FOOD_DESCRIPTION = "FoodDesctription";

    public static final String QUANTITY = "FoodQuantity";

    public static final String ALL_QUANTITY = "FoodAllQuantity";

    public static final String FOOD_PRICE = "FoodPrice";

    public static final String FOOD_PRICE_DISCOUNT = "FoodPriceDiscount";

    public static final String FOOD_PRICE_TOTAL = "FoodPriceTotal";
